...
active-session and sync records. Its scoped worker keeps Beta caching and
offline fallback changes out of Classic.
...
- A Classic shell asset change: the asset plus `sw.js` and PWA tests.
- A Beta shell asset change: the asset plus `beta/sw.js` and Beta tests.
